...
import { JoinRoomList } from "@/features/rooms/join-room-list";
    ...
    <main className="relative min-h-dvh overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-dvh w-full max-w-[430px] flex-col px-6 pt-[calc(env(safe-area-inset-top)+26px)] pb-[calc(env(safe-area-inset-bottom)+28px)]">
        ...
        <section className="mb-7 text-center">
          ...
          <p className="mt-2 text-base text-white/60">Select a waiting room</p>
        </section>

        <JoinRoomList initialRoomId={roomId} />
      </div>
    </main>
  );
}
